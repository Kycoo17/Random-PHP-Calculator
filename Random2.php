...
<input type="checkbox" name="cb1" value="Yes"> No repetir numeros<br>
 <p>Minimo <input type="text" name="min" /></p>
 ...
 <p><input type="submit" name="treasure" /></p>
</form>
...
//3.-	Creacion de condiciones erradas que causaran un codigo de error.
		...
		elseif($valores==null) {
			echo "<p style= \"color:red\"><strong>ERROR: </strong>No has insertado el numero de valores que deseas.</p>";
		}
		elseif ($max==0) {
